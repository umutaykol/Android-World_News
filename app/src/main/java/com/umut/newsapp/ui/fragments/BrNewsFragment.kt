...
import com.umut.newsapp.databinding.FragmentBrNewsBinding
...
@AndroidEntryPoint
class BrNewsFragment : Fragment() {

    private var _binding: FragmentBrNewsBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentBrNewsBinding.inflate(inflater, container, false)

        newsDataForTopHeadlines = MainActivity.brNews?.articles?.slice(0 until 5)
    ...
    private fun initRecyclerView() {
        binding.recyclerBrNews.apply {
            adapter = newsAdapter
            layoutManager = LinearLayoutManager(context, LinearLayoutManager.VERTICAL, false)
        }

        MainActivity.brNews?.articles?.let {
