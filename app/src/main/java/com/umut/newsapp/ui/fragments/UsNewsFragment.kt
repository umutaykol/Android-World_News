...
import com.umut.newsapp.databinding.FragmentUsNewsBinding
...
class UsNewsFragment : Fragment() {
    ...
    private var _binding: FragmentUsNewsBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentUsNewsBinding.inflate(inflater, container, false)

        newsDataForTopHeadlines = MainActivity.usNews?.articles?.slice(0 until 5)
    ...
    private fun initRecyclerView() {
        binding.recyclerUsNews.apply {
            adapter = newsAdapter
            layoutManager = LinearLayoutManager(context, LinearLayoutManager.VERTICAL, false)
        }

        MainActivity.usNews?.articles?.let {
